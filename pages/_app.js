...
function MyApp({ Component, pageProps }) {
  ...
  return (
    ...
    <Layout createClick={createAccountHandler} loginClick={loginShowHandler} logoutClick={logoutShowHandler} account={account} login={connectHandler} logout={disconnectHandler} isAuthenticated={isLoggedIn} onLogin={loginHandler} onLogout={logoutHandler}>
      <Component {...pageProps}  logoutClick={logoutHandler} isAuthenticated={isLoggedIn} loginClick={loginShowHandler} amountChange={setAmount} account={account} amount={amount} uroamount={uroSysAmount} riskamount={riskWeatherAmount} click={connectHandler} buyclick={buyHandler} contract={JuroTokenContract} logout={disconnectHandler} totalsupply={totalToken} onHide={modalHideHandler} modalClick={modalShowHandler} uroModalClick={uroModalShowHandler} riskModalClick={riskModalShowHandler} tokenName={tokenName} tokenName2={uroTokenName} tokenName3={riskTokenName}/>
    </Layout>
